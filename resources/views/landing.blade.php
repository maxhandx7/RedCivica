            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 text-center text-lg-start animate-on-scroll" style="animation-delay: 0.2s">
                    ...
                    <div class="mt-4 social-links">
                        <a href="#" class="animate__animated animate__pulse animate__infinite" style="animation-delay: 0.3s"><i class="fab fa-facebook-f"></i></a>
                        <a href="#" class="animate__animated animate__pulse animate__infinite" style="animation-delay: 0.4s"><i class="fab fa-twitter"></i></a>
                        <a href="#" class="animate__animated animate__pulse animate__infinite" style="animation-delay: 0.5s"><i class="fab fa-instagram"></i></a>
                        <a href="#" class="animate__animated animate__pulse animate__infinite" style="animation-delay: 0.6s"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-3 col-6 text-center animate-on-scroll" style="animation-delay: 0.2s">
                    <div class="p-4">
                        <div class="stats-counter">{{ $estadisticas['propuestas_destacadas'] ?? $candidato->propuestas->where('destacada', true)->count() }}</div>
                    ...
                    <div class="col-lg-4 animate-on-scroll" style="animation-delay: {{ $loop->index * 0.1 }}s">
                        <div class="proposal-card">
                            <div class="card-body p-4">
                                <div class="proposal-icon" style="background-color: {{ $propuesta->color }}20; color: {{ $propuesta->color }};">
                                    <i class="{{ $propuesta->icono }}"></i>
                                </div>
                                <span class="category-badge mb-3 d-inline-block" style="background-color: {{ $propuesta->color }}20; color: {{ $propuesta->color }};">
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        <div class="nav nav-pills justify-content-center" id="categoriesTab" role="tablist">
                            <button class="nav-link active mx-2 mb-2" id="all-tab" data-bs-toggle="pill" data-bs-target="#all" type="button">
                                Todas ({{ $candidato->propuestas->count() }})
                            </button>
                            @foreach($estadisticas['propuestas_por_categoria'] as $categoria => $total)
                            <button class="nav-link mx-2 mb-2" id="{{ $categoria }}-tab" data-bs-toggle="pill" data-bs-target="#{{ $categoria }}" type="button">
                                ...
                                <div class="proposal-card">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="proposal-icon me-3" style="background-color: {{ $propuesta->color }}20; color: {{ $propuesta->color }};">
                                                <i class="{{ $propuesta->icono }}"></i>
                                            </div>
                                            <div>
                                                <span class="category-badge d-inline-block mb-2" style="background-color: {{ $propuesta->color }}20; color: {{ $propuesta->color }};">
                                                    {{ $propuesta->categoria_formateada }}
                                                </span>
                                        ...
                                        <h5 class="card-title mb-3">{{ $propuesta->titulo }}</h5>
                                        <p class="card-text text-muted">{{ Str::limit($propuesta->descripcion, 150) }}</p>
                    ...
                    <div class="tab-pane fade" id="{{ $categoria }}" role="tabpanel">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="proposal-card">
                                    <div class="card-body p-4">
                                        <div class="proposal-icon mb-3" style="background-color: {{ $propuesta->color }}20; color: {{ $propuesta->color }};">
                                            <i class="{{ $propuesta->icono }}"></i>
                                        </div>
                                        <h5 class="card-title mb-3">{{ $propuesta->titulo }}</h5>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="mb-0 opacity-75">
                        Diseñado con <i class="fas fa-heart text-danger"></i> para los amigos de {{ request()->host() }}
                    </p>
                </div>
            </div>
        </div>
