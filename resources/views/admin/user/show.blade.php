                    ...
                    <div class="card card-borderless shadow-sm mb-4">
                        <div class="card-header bg-white">
                            <ul class="nav nav-tabs card-header-tabs" id="userTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="recruiter-tab" data-bs-toggle="tab"
                                        data-bs-target="#recruiter" type="button" role="tab" aria-controls="recruiter"
                                        aria-selected="false">
                                        <i class="bi-arrow-down-circle me-1"></i> Reclutado por
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="recruits-tab" data-bs-toggle="tab"
                                        data-bs-target="#recruits" type="button" role="tab" aria-controls="recruits"
                                        aria-selected="false">
                                        <i class="bi-arrow-up-circle me-1"></i> Reclutados
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span>{{ $user->telefono ?: 'Telefono no registrado' }}</span>
                                    </div>
                                </li>
                                <li class="list-group-item px-0 py-2">
                                    <div class="d-flex align-items-center">
                                ...
                                <li class="list-group-item px-0 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        @if ($user->direccion)
                                            <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($user->direccion) }}"
                                                target="_blank" class="text-decoration-none text-dark">
                                                {{ $user->direccion }}
                                            </a>
                                        @else
                                            <span class="text-muted">Dirección no registrada</span>
                                        @endif
                                    </div>
                                </li>
                                <li class="list-group-item px-0 py-2">
