<!-- resources/views/admin/tarjetones/edit.blade.php -->
@extends('layouts.admin')

@section('title', 'Editar Tarjetón')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Editar Tarjetón: {{ $tarjetone->nombre }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('tarjetones.update', $tarjetone) }}" method="POST" id="tarjetonForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('candidato_id') is-invalid @enderror" 
                                            ...
                                            @foreach($candidatos as $candidato)
                                                <option value="{{ $candidato->id }}" {{ old('candidato_id', $tarjetone->candidato_id) == $candidato->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="nombre" 
                                               name="nombre" 
                                               value="{{ old('nombre', $tarjetone->nombre) }}" 
                                               required>
                                        @error('nombre')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="total_opciones" 
                                               name="total_opciones" 
                                               value="{{ old('total_opciones', $tarjetone->total_opciones) }}" 
                                               required
                                               min="1"
                                               max="1000">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('instruccion') is-invalid @enderror" 
                                                  id="instruccion" 
                                                  name="instruccion" 
                                                  rows="3">{{ old('instruccion', $tarjetone->instruccion) }}</textarea>
                                        @error('instruccion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" 
                                                   ...
                                                   name="activo" 
                                                   value="1" 
                                                   {{ old('activo', $tarjetone->activo) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="color" 
                                                       ...
                                                       value="{{ old('configuracion.color_primario', $tarjetone->configuracion['color_primario'] ?? '#007bff') }}">
                                                <input type="text" 
                                                       class="form-control" 
                                                       value="{{ old('configuracion.color_primario', $tarjetone->configuracion['color_primario'] ?? '#007bff') }}"
                                                       readonly>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="color" 
                                                       ...
                                                       value="{{ old('configuracion.color_secundario', $tarjetone->configuracion['color_secundario'] ?? '#6c757d') }}">
                                                <input type="text" 
                                                       class="form-control" 
                                                       value="{{ old('configuracion.color_secundario', $tarjetone->configuracion['color_secundario'] ?? '#6c757d') }}"
                                                       readonly>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check mb-2">
                                                <input type="checkbox" 
                                                       ...
                                                       value="1" 
                                                       {{ old('configuracion.mostrar_numeros', $tarjetone->configuracion['mostrar_numeros'] ?? true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" 
                                                       ...
                                                       value="1" 
                                                       {{ old('configuracion.mostrar_nombres', $tarjetone->configuracion['mostrar_nombres'] ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="sectionsContainer">
                                        ...
                                        @php
                                            $secciones = old('secciones', $tarjetone->secciones);
                                        @endphp
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="number" 
                                                                   name="secciones[{{ $index }}][inicio]" 
                                                                   class="form-control section-start" 
                                                                   value="{{ $seccion['rango'][0] }}"
                                                                   min="1"
                                                                   required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="number" 
                                                                   name="secciones[{{ $index }}][fin]" 
                                                                   class="form-control section-end" 
                                                                   value="{{ $seccion['rango'][1] }}"
                                                                   min="1"
                                                                   required>
                                                        </div>
                                                        <div class="col-md-2">
                                                            ...
                                                            <input type="text" 
                                                                   ...
                                                                   value="{{ $seccion['rango'][1] - $seccion['rango'][0] + 1 }}"
                                                                   readonly>
                                                        </div>
                                                    </div>
                                                    <div class="mt-2 text-end">
                                                        <button type="button" class="btn btn-sm btn-outline-danger remove-section {{ count($secciones) == 1 ? 'd-none' : '' }}">
                                        ...
                                        <div class="alert alert-info">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <span id="totalSections">{{ count($secciones) }}</span> sección(es) | 
                                                    <span id="totalOptions">{{ array_sum(array_map(function($s) { return $s['rango'][1] - $s['rango'][0] + 1; }, $secciones)) }}</span> opciones de 
                                                    <span id="requiredOptions">{{ $tarjetone->total_opciones }}</span>
                                                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('tarjetones.show', $tarjetone) }}" class="btn btn-secondary">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="{{ route('tarjetones.preview', $tarjetone) }}" 
                                       class="btn btn-outline-info" 
                                       target="_blank">
                                        <i class="fas fa-search me-2"></i> Vista Previa
                                    </a>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Variables (similar a create.blade.php pero con datos existentes)
    let sectionCount = {{ count($secciones) }};
    ...
    // Solo agregar esta función para inicializar correctamente
